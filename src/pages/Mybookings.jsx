...
<div key={booking._id}  className='w-full border-b border-gray-300 first:border-t py-6 grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr]'>
  {/* Hotel details  */}
  <div className='flex flex-col md:flex-row'>
    <img src={booking.room.images[0]} alt="hotel-images" className='min-md:w-44 rounded shadow object-cover'/>
    <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
      <p className='text-2xl font-playfair '>{booking.hotel.name} <span className='text-sm font-inter'>({booking.room.roomType})</span></p>
      ...
      <div className='flex items-center font-bold'>
        <p>Total: ${booking.room.pricePerNight}</p>
      </div>
    </div>
  </div>
  {/* date & timing details  */}
